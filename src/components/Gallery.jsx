  ...
  return (
    <section id="gallery" className="py-20 bg-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="font-neutra-book uppercase text-xs tracking-[0.25em] text-white/60 mb-3 font-semibold">
            Courts & Atmosphere
          </p>
          <h2 className="font-neutra-bold text-2xl sm:text-3xl md:text-4xl text-white mb-3 uppercase tracking-tight">
            Experience Our Padel Spaces
          </h2>
          <p className="font-neutra-book text-lg text-white/80 max-w-2xl mx-auto font-medium">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5">
              <div className="flex flex-col gap-3 bg-white/15 backdrop-blur-md border border-white/15 rounded-xl px-4 py-3 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.5)]">
                <div className="flex items-center gap-3 text-xs font-neutra-book font-semibold uppercase tracking-[0.15em] text-white/85">
                ...
                <p className="font-neutra-book text-lg font-bold text-white leading-snug uppercase">
                  {images[current].caption}
                </p>
                <div className="flex gap-2 items-center text-white/80 text-sm font-neutra-book font-medium">
            ...
            {images.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-xs text-white font-neutra-book">
